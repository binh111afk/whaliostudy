...
const Header = ({ user, onLoginClick, onLogoutClick }) => {
  ...
  return (
    ...
    <div className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-50">
      {/* 1. TÌM KIẾM */}
      <div className="flex items-center bg-gray-50 rounded-xl px-4 py-2 w-64 lg:w-80 border border-transparent focus-within:border-blue-500/30 focus-within:bg-white transition-all">
