...
const SurvivalModePanel = ({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50/50 to-gray-50 dark:from-gray-800 dark:to-gray-800/50 border-2 border-[#134691] dark:border-[#134691]/80 rounded-xl p-4 shadow-sm">
