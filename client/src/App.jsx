...
const MobileBottomNav = ({ user, onLoginClick, onLogoutClick }) => {
  ...
  return (
    <>
      <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white/95 px-2 py-2 backdrop-blur-lg dark:border-gray-700 dark:bg-gray-900/95 min-[1025px]:hidden">
              ...
              isAiChatFullscreen
                ...
                : isCodeVaultFullscreen
                  ...
                  : location.pathname === "/ai-assistant"
                    ? "min-w-0 flex flex-col flex-1 overflow-hidden p-0 pt-[56px] min-[1025px]:pt-0"
